...
class App extends Component {
  ...
  render() {
    ...
    var movieList = this.state.movies.map((movie, i) => {
      ...
      return(<Movies key={i} movieName={movie.title} movieDesc={movie.overview} movieImg={movie.poster_path} displayOnlyLike={this.state.viewOnlyLike} handleClickParent={this.handleClick} idMovie={movie.id} isLiked={isLiked}/>)
    });
